#!/usr/bin/python3
# original reference : https://github.com/adafruit/linker-map-summary
		...
		for line in lines:
			...
			if line.startswith((".", " .", " *fill*")):
				...
				if (line.startswith('.')): # start of section
					...
					if part[0] == '*fill*': # CAUTION : sometimes gcc generate incorrect value for 'fill' section
						source = part[0]
						size = int(part[-1], 16)
